...
contract WethFtmVaultDeployer is Script {
    address AMDIN = 0xdeD212B8BAb662B98f49e757CbB409BB7808dc10;

    address PAIR_FANTOM = 0x3A3eaf4bE38C4FC1a6BF1b8893bd3FdB7E75c3a1; // weth-ftm
    ...
    function run() public {
        ...
        // TODO set Aum fee= 400 , set operator=0xcaD3477b8D2569c849298E82D10046eD422AC258
    }
}
